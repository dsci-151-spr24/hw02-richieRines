...
***Some people make way more money than most and others make way less money that most. The median average does not take extremes into account. ***
...
***I chose 5000 because I believe it makes the graph much easier to see and understand***
...
***I would say the median summary statistic would be of the most use. This value is 3600 and it makes up the the income of the majority***
...
***Engineering has the highest typical median with 57000***
...
***Interdisciplinary is the least popular***
...
***Geosciences, Environmental Science, Multi-Disciplinary Or General Science, Physiology, Communication Technologies, Neuroscience, Atmospheric Sciences And Meteorology, Miscellaneous Biology, Biology, Ecology, Zoology***
...
***Many women tend to major in fields that are not stem-related. Those who do major in stem fields tend to have a higher median income as opposed to those who don't***

## Further exploration

10. Ask a question of interest to you, and answer it using summary statistic(s) and/or visualization(s).

## What is the unemployment rate of stem majors? What about non-stem majors?

```{r}
college_recent_grads %>%
  ggplot(aes(x = unemployment_rate, fill = major_type)) +
...
***Looking at the histogram we can see that non-stem majors have a much hugher unemployment rate than stem related majors.***
